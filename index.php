    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          ...
          <h6 class="text-muted">Business Internet Broadband | เข้าถึงข้อมูลทั่วโลกทันสมัยด้วยอินเทอร์เน็ตความเร็วสูง</h6>
          <br>
        </div>
      </div>
      <div class="row">
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                ...
                <h2 class="text-uppercase">ค่าบริการรายเดือน 799</h2>
