...
<body id="page-top">
  ...
  <form id="checkout-form" class="checkout-form" action="/checkout.php" method="POST">
    ...
    <div class="card mb-4 shadow-sm">
      ...
      <div class="card-body">
        <h1>Package</h1>
        <h2 class="card-title pricing-card-title">ค่าบริการ 2999 บาท <small class="text-muted">/ เดือน</small></h2>
        <ul class="list-unstyled mt-3 mb-4">
          <li>ความเร็วดาวน์โหลดสูงสุด 1000/500 Mbs</li>
          <br>
        ...
        <button type="button" class="btn btn-lg btn-block btn-outline-primary" onclick="window.location='index.php'">กลับสู่หน้าหลัก</button>
      </div>
    </div>
